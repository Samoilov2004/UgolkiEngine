...
выборкой. В экспериментах с бюджетом 1\,500~эпизодов и 2~инициализациями
...
неочевидна~\cite{Hessel18}. Аблационный анализ по~$\alpha$ позволяет
...
Conv${\times}2\to$Linear${\times}2$. Proportional~PER:
\begin{equation}\label{Eq1}
    p_i = |\delta_i|+\varepsilon,\qquad
    P(i)=\frac{p_i^{\,\alpha}}{\sum_j p_j^{\,\alpha}},
\end{equation}
IS-веса $\beta{:}\ 0{,}4{\to}1{,}0$. Варьировался один параметр:
$\alpha \in \{0;\,0{,}3;\,0{,}6;\,0{,}9\}$; прочие гиперпараметры DQN
фиксированы; по~2~инициализации на условие; 1\,500~эпизодов self-play. Оценка~---
1\,000~партий против Greedy/Heuristic/Random с чередованием первого хода;
метрика~--- доля побед в результативных партиях (ничьи исключены);
95\%~bootstrap-ДИ по партиям (10\,000~ресэмплов).
...
дисперсии между инициализациями при $n{=}2$ ограничена.

\textbf{Заключение.}
При бюджете 1\,500~эпизодов наблюдалась тенденция снижения качества политики
с ростом~$\alpha$: при $\alpha{=}0{,}3$ потери составили $2{,}4$~п.п. (могут
лежать в пределах вариативности между запусками), при $\alpha{=}0{,}6$ и
$\alpha{=}0{,}9$~--- $10{,}9$ и $18{,}7$~п.п. Это согласуется с гипотезой о
дестабилизирующем влиянии агрессивной приоритизации в нестационарном self-play.
Тенденция требует подтверждения при ${\ge}5$~инициализациях и бюджете
${\ge}5\,000$~эпизодов. Перспективы: адаптивный~$\alpha$, совместный подбор
$\alpha$ и~$\beta$.
